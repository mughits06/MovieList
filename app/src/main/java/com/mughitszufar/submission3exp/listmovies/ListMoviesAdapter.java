...
public class ListMoviesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<ResultsItems> itemList = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            final ResultsItems model = getItem(position);
    ...
    private ResultsItems getItem(int position) {
        return itemList.get(position);
    }

    public void setData(List<ResultsItems> resultsItems) {
        this.itemList.clear();
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, ResultsItems model);
    }
